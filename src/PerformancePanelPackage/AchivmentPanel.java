...
public class AchivmentPanel extends JPanel {
	...
	private CircleProgressBar probar;
	private AchivmentDataPanel dataPanel;

	
	public AchivmentPanel() {
		
		probar = new CircleProgressBar();
		dataPanel = new AchivmentDataPanel();
		probar.setFont(new Font("Tahoma", Font.BOLD, 20));
		probar.setForeground(Color.ORANGE);
